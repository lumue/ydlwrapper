...
public class NewDownloadStatusMessage extends YdlStatusMessage{
	...
	private final static Function<String,String> EXTENSION_PARSER= line -> line.substring(line.lastIndexOf('.') +1);
	private static final Function<String,String> FORMAT_ID_PARSER = line -> line.substring(line.lastIndexOf(".f") +1,line.lastIndexOf('.'));;
